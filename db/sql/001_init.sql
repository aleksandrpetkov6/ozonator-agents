...
CREATE INDEX IF NOT EXISTS ix_tasks_target_agent ON tasks(target_agent);
...
CREATE INDEX IF NOT EXISTS ix_qa_reports_task_id ON qa_reports(task_id);
CREATE INDEX IF NOT EXISTS ix_qa_reports_agent_code ON qa_reports(agent_code);
CREATE INDEX IF NOT EXISTS ix_qa_reports_created_at ON qa_reports(created_at);
...
CREATE INDEX IF NOT EXISTS ix_qa_findings_qa_report_id ON qa_findings(qa_report_id);
CREATE INDEX IF NOT EXISTS ix_qa_findings_severity ON qa_findings(severity);
...
CREATE INDEX IF NOT EXISTS ix_agent_instructions_agent_code ON agent_instructions(agent_code);
CREATE INDEX IF NOT EXISTS ix_agent_instructions_is_active ON agent_instructions(is_active);
...
CREATE UNIQUE INDEX IF NOT EXISTS ux_communication_rules_rule_key ON communication_rules(rule_key);
CREATE INDEX IF NOT EXISTS ix_communication_rules_scope ON communication_rules(scope);
CREATE INDEX IF NOT EXISTS ix_communication_rules_is_active ON communication_rules(is_active);
...
CREATE INDEX IF NOT EXISTS ix_orchestration_logs_task_id ON orchestration_logs(task_id);
CREATE INDEX IF NOT EXISTS ix_orchestration_logs_event_type ON orchestration_logs(event_type);
CREATE INDEX IF NOT EXISTS ix_orchestration_logs_created_at ON orchestration_logs(created_at);

-- 7) agent_state: устойчивое состояние агентов (например SelfProfile Екатерины)
